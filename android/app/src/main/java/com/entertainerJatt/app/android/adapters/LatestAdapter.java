...
public class LatestAdapter extends RecyclerView.Adapter {
    ...
    public LatestAdapter(Context context, ArrayList<HashMap<String, String>> songList) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolderValue, final int position) {
        if (viewHolderValue instanceof LatestAdapter.ViewItem) {
            final LatestAdapter.ViewItem viewHolder = (LatestAdapter.ViewItem) viewHolderValue;
