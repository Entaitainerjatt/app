...
import com.entertainerJatt.app.android.adapters.UpcomingAdapter;
import com.entertainerJatt.app.android.asyncTask.UpcomingSongsAsynTask;
...
public class UpcominingFragment extends Fragment implements View.OnClickListener, IAsyncTask {
    ...
    private UpcomingAdapter adapter = null;
        ...
        try {
            ...
            if (AlbumssongArrayList.size() > 0) {
                ...
                if (isFirstTimeAdapter) {
                    ...
                    adapter = new UpcomingAdapter(context, AlbumssongArrayList);
...
//                });
    ...
    private void getSongs(int start, int end) throws Exception {
        ...
        UpcomingSongsAsynTask upcomingSongsAsynTask = new UpcomingSongsAsynTask(userInfo, UpcominingFragment.this);
        upcomingSongsAsynTask.execute();
    }
}
